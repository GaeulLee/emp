...
<html>
	...
	<body>
		<div class="container w-75 mx-auto">
			...
			<!-- 본문 시작 -->
			<div class="rounded mt-1 h4 text-white" id="title">게시물 수정</div>
			<form action="<%=request.getContextPath()%>/board/updateBoardAction.jsp" method="post">
				...
				%>
					...
					<tr>
						...
						<td>
							<input type="text" name="boardPw" class="form-control" placeholder="수정을 위한 비밀번호를 입력해주세요.">
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<a href="<%=request.getContextPath()%>/board/boardList.jsp" class="btn btn-outline-primary float-start">BACK</a>
							<button type="submit" class="btn btn-light float-end me-2">수정</button>
						</td>
					</tr>
				</table>
			</form>
